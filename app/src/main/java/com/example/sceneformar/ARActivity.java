...
public class ARActivity extends AppCompatActivity {
    ...
    private final boolean isUsingFrontCamera = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hashMap.put("T shirt (white)", new ARProductData(R.raw.tshirt_ar_flipkart, 0.30f, 0.35f));
      

        // hashMap.put("Jeans (Size 32)", new ARProductData(R.raw.jeans_ar_flipkart, 0.8f, 0.85f));
       // hashMap.put("Dress (Size M)", new ARProductData(R.raw.dress_ar_flipkart, 0.9f, 0.95f));
        ...
        try {
            for (String cameraId : cameraManager.getCameraIdList()) {
                ...
                if (facing != null && facing == CameraCharacteristics.LENS_FACING_FRONT) {
                    ...
                    // You can use the cameraId to open the front camera using the Camera2 API
                    // Note: Implementing the full camera setup is beyond the scope of this example
                    break;
                }
            }
